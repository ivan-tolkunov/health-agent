...
export type ThreadProps = {
	...
	composerLeading?: ReactNode | undefined;
};
...
export const Thread: FC<ThreadProps> = ({
	...
	return (
		<ThreadComponentsContext.Provider value={components}>
			<ThreadRoot isEmpty={isEmpty} composerLeading={composerLeading} />
		</ThreadComponentsContext.Provider>
	);
};

const ThreadRoot: FC<{ isEmpty: boolean; composerLeading?: ReactNode }> = ({
	isEmpty,
	composerLeading,
}) => {
...
const Composer: FC<{ leading?: ReactNode }> = ({ leading }) => {
	return (
